						...
						<v-tabs-items v-model="dialogHelpTabs">
								...
								<v-container fluid>
									<v-row class="d-flex align-start">
										<v-col cols="12" class="d-flex">
											<div class="ml-10">
												<p>Sovellukseen liittyvistä ongelmista voit ilmoittaa osoitteeseen <a href="mailto:virma@lounaistieto.fi">virma@lounaistieto.fi</a></p>
											</div>
										</v-col>
									</v-row>
							...
							<v-tab-item>
								<v-container fluid>
									...
									<v-row class="d-flex align-start">
										<v-col cols="12" class="d-flex">
												<p class=" text-justify">Virma Kartta -verkkopalvelua sekä virkistysreitteihin ja -kohteisiin liittyviä aineistoja ja palveluita kehitetään <a href="https://www.varsinais-suomi.fi/fi/" target="_blank" rel="nofollow noreferrer">Varsinais-Suomen liiton</a>, <a href="https://www.lounaistieto.fi/" target="_blank" rel="nofollow noreferrer">Lounaistiedon</a>, <a href="https://www.valonia.fi/" target="_blank" rel="nofollow noreferrer">Valonian</a>, <a href="https://lansi-suomi.proagria.fi/" target="_blank" rel="nofollow noreferrer">ProAgria Länsi-Suomen</a>&nbsp;/ <a href="https://lansi-suomi.maajakotitalousnaiset.fi/sisalto/lansi-suomen-maa-ja-kotitalousnaiset-1427" target="_blank" rel="nofollow noreferrer">Länsi-Suomen maa- ja kotitalousnaisten</a> ja <a href="https://comp.utu.fi" target="_blank" rel="nofollow noreferrer">Turun yliopiston Tietotekniikan laitoksen</a> yhteistyönä <b>Digitaalisen saavutettavuuden parantaminen virkistyspalveluissa (Digi-SAAPAS) -hankkeessa</b>, jota rahoittaa Varsinais-Suomen ELY-keskus osana Euroopan unionin maaseudun kehittämisohjelmaa. Hanke on käynnisssä vuosina 2020–2022.</p>
										</v-col>
									</v-row>	
